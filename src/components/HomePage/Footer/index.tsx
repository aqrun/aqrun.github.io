export const Footer = () => {
  return (
    <section className='oic-page-footer overflow-x-hidden'>
      <div className='w-screen flex-col px-6 pt-20 pb-8 text-slate-700 lg:flex lg:px-10 xl:px-24 border-solid border border-gray-200'>
        {/* <!-- TOP CONTAINER --> */}
        <div className='layout lg:flex lg:flex-row lg:justify-between'>
          {/* <!-- LOGO DIV --> */}
          <div>
            {/* <!-- LOGO --> */}
        ...
        {/* <!-- DIVIDER --> */}
        <div className='layout mx-auto mt-12 mb-8 w-full border border-[#E4E4E7]'></div>
        {/* <!-- COPYRIGHT TEXT --> */}
        <div className='layout'>
          ...
          <p className='font-inter lg:text-center text-sm text-gray-500'>
            ...
            <a
              ...
              target='_blank'
              className='inline-block mx-1 hover:text-violet-500'
            >
              Rust
            </a>
            &
