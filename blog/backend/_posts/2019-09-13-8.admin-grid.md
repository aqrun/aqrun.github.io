...
title: '8.如何添加后台数据网格'
tags: php magento2
excerpt: 'Magento 2 网格是一种数据表格，用来显示数据库中对应表的数据，并提供了排序、筛选、删除、更新数据的功能'
---
...
![8-post-list-1.png](/public/images/magento2/8-post-list-1.png)
...
![8-post-list-2.png](/public/images/magento2/8-post-list-2.png)
...
![8-post-list-3.png](/public/images/magento2/8-post-list-3.png)
